...
public class PatientService {
    ...
    public  String savePatientDetails(Patient patient) throws ExecutionException, InterruptedException {
        ...
        ApiFuture<WriteResult> collectionsApiFuture = dbFirestore.collection(COL_NAME).document(name).set(patient);
        Timestamp updateTime = collectionsApiFuture.get().getUpdateTime();
